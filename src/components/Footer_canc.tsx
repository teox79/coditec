...
const Contact: React.FC = () => {
    ...
    const mailtoLink = `mailto:${contactData?.contactInfo?.email}?subject=${encodeURIComponent(formData.subject)}&body=Nome: ${encodeURIComponent(formData.name)}%0AEmail: ${encodeURIComponent(formData.email)}%0AMessaggio: ${encodeURIComponent(formData.message)}`;
                                ...
                                <form className="php-email-form" data-aos="fade-up" data-aos-delay="200">
                                    <div className="row gy-4">
                                        ...
                                        <div className="col-md-12 text-center">
                                            ...
                                            <div className="sent-message">Il tuo messaggio è stato inviato</div>
